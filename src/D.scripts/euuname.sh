: euuname.sh -- controlled reply to uuname messages
:
: By cbosg!mcnc!unc!smb, Sat Feb 27 05:45:42 1982
: Here is a shell file that should be distributed with netnews.
