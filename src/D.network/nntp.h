/* nntp.h -- NNTP server interface functions */

extern	int	nntpinit();
extern  void	nntpput();
extern	int	nntpget();
extern	void	nntpclose();

extern	void	nntpsync();
extern	int	nntpcommand();
extern	int	nntpsnarf();
extern	int	nntpspew();

/*
 * Response codes for NNTP server
 *
 * These are fixed by RFC-977; don't muck with them!
 *
 * First digit:
 *
...
/* RFC 977 defines this, too; don't change it. */
