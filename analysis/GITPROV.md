...
Television's **first crowd-sourced scripted series**:
...
The tools didn't die when Current TV shut down.
...
**Git IS collaborative storytelling infrastructure.** We just never used it that way.
...
Doug Engelbart's NLS (1968) demonstrated:
- Multi-user real-time collaboration
- Shared workspaces
- Version control concepts
- Augmented human intellect through tools

**GitHub is NLS for the masses.** And this is what happens when you use it for theater instead of code.
