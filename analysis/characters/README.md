...
Sock puppets for collaborative performance art. Anyone can wear a mask.

## The Cast

| Dir | Emoji | Archetype | Branch |
|-----|-------|-----------|--------|
| [daFlute/](daFlute/) | 📜 | Aging Hacker Who Wrote The Book | `dev` |
...
| [SecAuditDAOBot-69420/](SecAuditDAOBot-69420/) | 🪙 | Crypto Scam Bot | `web3-security-solution` |

## Files Per Character

Each directory contains:
- `CHARACTER.yml` — The soul (required)
- `README.md` — Copy-paste signatures (optional)
...
Front signature. Content. Back signature.
...
🎭🪙 [*SecAuditDAOBot-69420*](https://github.com/SimHacker/tmnn7-8/tree/main/analysis/characters/SecAuditDAOBot-69420):
```

## Rules

1. Characters are MASKS, not real people
2. 🎭 prefix = "this is roleplay"
3. Your GitHub identity is visible
4. Satire, not harassment

## See Also

- [Green Room](../rooms/green-room/) — Where characters hang out
- [SIMULATION.yml](../SIMULATION.yml) — How to orchestrate
